...
namespace AngularApiMain.Migrations
{
    ...
    [Migration("20231004195412_intialcreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AngularApiMain.Models.FoodItem", b =>
                {
                    b.HasOne("AngularApiMain.Models.Order", null)
                        .WithMany("Food")
            ...
            modelBuilder.Entity("AngularApiMain.Models.Order", b =>
                {
                    b.HasOne("AngularApiMain.Models.Restaurant", "Restaurant")
                        .WithMany("Orders")
                        .HasForeignKey("RestaurantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AngularApiMain.Models.User", "User")
                        .WithMany("Orders")
